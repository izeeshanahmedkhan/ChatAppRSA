<template>
    <div class="list-group">
        <a v-for="latestMessage in latestMessages" @click="onClick(latestMessage.connected_user_id)" :key="latestMessage.id" href="#" class="list-group-item list-group-item-action flex-column align-items-start connected-users" data-toggle="list">
